...
const TOOL_LABELS: Record<string, string> = {
  ...
  listGoogleTasks: "Listing Google Tasks",
  createGoogleTask: "Creating Google Task",
  listGoogleSheets: "Listing Google Sheets",
  createGoogleSheet: "Creating Google Sheet",
  appendGoogleSheetRow: "Appending Google Sheet row",
